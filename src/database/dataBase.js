...
module.exports = {
    ...
    subcategories : JSON.parse(fs.readFileSync(path.join(__dirname,'/subcategories.json'), 'utf-8')),
    ...
    writeSubcategoriesJson : (dataBase) =>  {
        fs.writeFileSync(path.join(__dirname,'/subcategories.json'),JSON.stringify(dataBase))
    },
